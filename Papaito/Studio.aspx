<%@ Page Title="" Language="C#" MasterPageFile="~/MasterStudio.master" AutoEventWireup="true"
    CodeFile="Studio.aspx.cs" Inherits="Studio" %>
...
<html>
	<head>
        ...
        function() {
		    window.setTimeout(function() {
		       ...
		       // PreLoadStudio.src = "Studio/black.jpg";
		    }, 4000);
		    $('#container').hide()
        });
		</script>
	...
	<body>
		<div id="page">
		<img runat="server" src="" id="PreLoadStudio" alt="" style="position:relative; margin-top:65px; width:819px; height:370px; border:1px solid #fff" />
			<div id="container">
				...
				<div id="thumbs" class="navigation">
					<ul class="thumbs">
						<li>
							<a class="thumb" runat="server" id="RecordImg1">
								<img src="Gallerycss/bt1.png" alt="" />
							</a>
						</li>

						<li>
							<a class="thumb" runat="server" id="RecordImg2">
								<img src="Gallerycss/bt2.png" alt="" />
							</a>
						</li>

						<li>
							<a class="thumb" runat="server" id="RecordImg3">
								<img src="Gallerycss/bt3.png" alt="" />
							</a>
						</li>

						<li>
							<a class="thumb" runat="server" id="ControlImg1">
								<img class="ControlRoom" src="Gallerycss/bt1.png" alt="" />
							</a>
						</li>

						<li>
							<a class="thumb" runat="server" id="ControlImg2">
								<img src="Gallerycss/bt2.png" alt="" />
							</a>
						</li>

						<li>
							<a class="thumb" runat="server" id="ControlImg3">
								<img src="Gallerycss/bt3.png" alt="" />
							</a>
						</li>

						<li>
							<a class="thumb" runat="server" id="LookAroundImg1">
								<img class="LookAroundStudio" src="Gallerycss/bt1.png" alt="" />
							</a>
						</li>

						<li>
							<a class="thumb" runat="server" id="LookAroundImg2">
								<img src="Gallerycss/bt2.png" alt="" />
							</a>
						</li>
    ...
    <div id="templatemo_content_area">
        <div class="space9_gallery">
            <div class="templaetmo1_3_col" style="margin-top:-70px";>
                <h1 id="AboutTheStudio" runat="server" >
                    </h1>
                <div class="space4">
            </div>
            ...
            <div class="templaetmo_3_col templatemo_3_col_middle" style="margin-top:-70px";>
                <h1 id="WhoPlaysHere" runat="server" >
                    </h1>
                <div class="cleaner">
                </div>
